...
//            //IPHostEntry ipHostInfo = Dns.GetHostEntry("127.0.0.1");// throws and error with this
//            IPHostEntry ipHostInfo = Dns.Resolve("127.0.0.1");
//            IPAddress ipAddress = ipHostInfo.AddressList[0];
//            IPEndPoint localEndPoint = new IPEndPoint(ipAddress, 4505);
...
//        //static Socket handler ;//= listener.EndAccept(ar);
